 ...
 */
export type WatchDirectory = (path: string, callback: (filePaths: string[]) => void) => {
    stop: () => void;
 ...
 */
export type WatchFile = (path: string, callback: (contents: string | null) => void) => {
    stop: () => void;
 ...
 * @returns a function that will stop watching the file
 */
export type WatchFileExports = (path: string, callback: (exportNames: string[]) => void) => {
    stop: () => void;
